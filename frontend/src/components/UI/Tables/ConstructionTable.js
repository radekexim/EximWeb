...
export const ConstructionTable = (props) => {
    ...
    const total = subtotal(props.data);
    return (
                    ...
                    <Table key={uuid()}>
                        ...
                        <TableFooter sx={{ backgroundColor: "#F3F4F6" }}>
                            <TableRow>
                                ...
                                <TableCell sx={{ fontSize: "1rem", fontWeight: "bold" }}>{total.totalQuantity.toFixed(2)}</TableCell>
                                <TableCell sx={{ fontSize: "1rem", fontWeight: "bold" }}>{total.totalUnits.toFixed(2)}</TableCell>
                            </TableRow>
                        </TableFooter>
                    </Table>
                </Box>
